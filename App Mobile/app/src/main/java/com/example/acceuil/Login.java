...
//--------------------------------------------------------------------------------------------------
        ...
        joinus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //====== Send Request
                Call<LoginData> call = api.signupUser(mail,password) ;
                ...
                call.enqueue(new Callback<LoginData>() {
                    ...
                    public void onResponse(@NotNull Call<LoginData> call, @NotNull Response<LoginData> response) {
                        if (response.isSuccessful()) {
                            ...
                            if (response.message().contains("Login Success")) {
                    ...
                    @Override
                    public void onFailure(@NotNull Call<LoginData> call, Throwable t) {
